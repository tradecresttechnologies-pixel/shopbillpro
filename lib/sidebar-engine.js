...
window.SBPSidebar = (function() {
  ...
  const MODULE_CATALOG = {
    ...
    'authorized_users':{ href: 'authorized-users.html', icon: '🔒', label_en: 'Authorized Users', label_hi: 'अधिकृत उपयोगकर्ता', order: 122 },
    'audit_log':       { href: 'audit-log.html',        icon: '📋', label_en: 'Audit Log',        label_hi: 'ऑडिट लॉग',          order: 124 },
