...
//
// v3.8 (this file): per-page generation mode for chained client-side multi-page
//
// CHANGES vs v3.7:
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // 2. Fetch active prompt template (v3.8: page-aware via page_slug)
    ...
    console.log(`[v3.8] plan=${planNorm} page=${pageSlug} resolved_provider=${resolvedProvider} final=${providerUsed}`);
