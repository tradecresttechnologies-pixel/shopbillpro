...
//
// v3.7 (this file): admin-panel provider routing via _internal_resolve_ai_provider
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log(`[v3.7] plan=${planNorm} resolved_provider=${resolvedProvider} final=${providerUsed}`);
